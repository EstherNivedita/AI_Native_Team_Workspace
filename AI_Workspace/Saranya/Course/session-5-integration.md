...
### Recap and bridge
"This is our final session. Over four days you've built context files, organized references, written skill files, and created an agent system with sub-agents. Today we're going to tie everything together — make sure your workspace is complete, create one more critical skill, and step back to see the full architecture of what you've built and how it maps to the product you're designing."

### Build: Create skills/design-handoff.md
Guide them through creating a design handoff template as a skill file. This is a structured spec that covers everything a developer needs when receiving a design:

Help them articulate the sections: screen/component name, design intent and user goal, layout specifications (grid, breakpoints, responsive behavior), interaction states (default, hover, active, disabled, error, loading), typography specs per element, color usage per element, spacing and padding values, accessibility requirements (contrast ratios, ARIA labels, focus states, keyboard navigation), assets to export, edge cases and content overflow behavior, and any animations or transitions.

Ask: "When you hand off designs today, what questions does the dev team always come back with?" Build those into the template as required fields. The goal is to eliminate back-and-forth by making the handoff comprehensive upfront.
...
Guide them to create a README for their workspace that documents what everything is and how to use it. Structure:
...
Start a changelog that tracks changes to their workspace over time. First entry covers everything built during the course. Explain: "Your skill files and context docs will evolve. When you update your brand guidelines, when you refine your review criteria after using them — log it here. This is version control for your AI workflow, just like you version your design files."
...
### Final reflection
"You started this week opening a terminal for the first time and cloning a repository. Now you have a complete AI-powered design workspace with persistent context, organized references, articulated skills, and an agent system with sub-agents. You understand context windows, RAG, skills, agents, routing, and evaluation. More importantly, you understand the architecture of the product you design every day. How will this change the way you approach your work — both using AI tools and designing for an AI product?"
